...
export default function Home() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-4 py-8">
      <div className="card-surface fade-in-up rounded-[2rem] p-6">
        {/* Brand mark */}
        <div className="flex items-center gap-2">
          <span className="text-2xl">☕</span>
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[var(--accent-gold)]/90">
            Cafe Coffee Aroma
          </p>
        </div>
        ...
        >
          <label className="block">
            ...
            <input
              ...
              placeholder="T1"
              className="input-surface mt-2 w-full rounded-2xl px-4 py-3 text-base outline-none"
            />
          </label>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            ...
            <Link
              ...
              className="btn-ghost inline-flex min-h-12 items-center justify-center rounded-2xl border border-[var(--border-warm)] bg-[var(--bg-surface)] px-5 text-sm font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
            >
              Explore Menu
            </Link>
          </div>
